...
/* Modul implementasi ADT Linked List Sederhana */
...
/* menambahkan elemen pertama dengan nilai X jika alokasi berhasil */
{
	...
	address P;
	 /* Algoritma */
	/* alokasi node baru lalu sisip di depan */
	P = Alokasi(X);
	if (P != Nil)
	{
		InsertFirst(L, P);
...
/* bernilai X jika alokasi berhasil. Jika alokasi gagal IS = FS */
{
	...
	address P;
	 ...
	 /* Algoritma */
	/* alokasi node baru lalu sisip di belakang */
	P = Alokasi(X);
	if (P != Nil)
	{
		InsertLast(L, P);
...
/* 	dan alamat elemen pertama di dealokasi */
{
	...
	address P;
	 /* Algoritma */
	/* ambil node pertama, simpan nilainya, lalu dealokasi */
	DelFirst(L, &P);
	*X = Info(P);
	DeAlokasi(P);
}
...
/* 	dan alamat elemen terakhir di dealokasi */
{
	...
	address PDel;
	 /* Algoritma */
	/* hapus node terakhir, ambil nilainya, lalu dealokasi */
	DelLast(L, &PDel);
	*X = Info(PDel);
	DeAlokasi(PDel);
}
...
{
	/* sisip node P di antara Prec dan next(Prec) */
	Next(P) = Next(Prec);
	Next(Prec) = P;
}
...
/* Delete semua elemen list dan alamat elemen di dealokasi */
{
	...
	address PDel;
	 /* Algoritma */
	/* hapus dari depan sampai list kosong */
	while (!ListEmpty(*L))
	{
		DelFirst(L, &PDel);
		DeAlokasi(PDel);
